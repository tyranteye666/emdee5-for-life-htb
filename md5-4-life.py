...
#takeaways : putting the URL into a variable & making a GET request in another would be faster. or may need to run script a few more times to work (at least for me)
